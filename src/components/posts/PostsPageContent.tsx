                                    ...
                                    <button
                                        ...
                                        className={`px-2.5 py-1 rounded-full text-xs font-medium transition-all ${
                                            selectedTag === tag
                                                ...
                                                : 'bg-[var(--color-background)] text-[var(--color-accent)] border border-[var(--color-accent)]/30 hover:border-[var(--color-accent)] hover:bg-[var(--color-accent)]/10'
                                        }`}
                                    >
    ...
    return (
        ...
        >
            ...
            <div className="p-6">
                ...
                <Link
                    href={`/${pageType === 'study' ? 'estudos' : 'blog'}/${post.slug || post.id}`}
