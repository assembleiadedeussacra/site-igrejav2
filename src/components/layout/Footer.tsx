...
export default function Footer({ settings }: FooterProps) {
    ...
    return (
        <footer className="relative bg-[var(--color-accent)] text-white overflow-hidden">
            ...
            <button
                onClick={scrollToTop}
                className="fixed bottom-6 right-6 w-12 h-12 bg-[var(--color-primary)] text-[var(--color-accent)] rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform z-40"
