...
CREATE TABLE IF NOT EXISTS site_settings (
  ...
  email TEXT NOT NULL DEFAULT 'contato@assembleiadedeussacramento.com.br',
...
SELECT
  ...
  '38190-000',
  '34984327019',
  'contato@assembleiadedeussacramento.com.br',
...
-- Analytics RPCs (filtros: seção, dispositivo, cidade)
...
EXCEPTION
  WHEN duplicate_object THEN NULL;
  WHEN others THEN
    RAISE NOTICE 'Realtime page_views: %', SQLERRM;
END $$;

-- Incremento seguro de views de posts (anon via RPC)
